...
NUMERIC_FEATURES = [
    ...
    "max_precip_6h_mm",
    "max_precip_12h_mm",
    "hours_since_precip_over_1mm",
    "hours_since_precip_over_5mm",
    "hours_since_precip_over_10mm",
    "antecedent_precipitation_index",
    "temperature2mAtObservation",
    "soilMoisture0To7cmAtObservation",
    "rainAtObservationHour",
    "snowfallAtObservationHour",
]
